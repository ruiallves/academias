 ...
 *
 * Gémeo do ficheiro com o mesmo nome na consola, e de propósito: são duas
 * aplicações separadas, sem pacote partilhado de componentes, e a espera deve
 * ter a mesma cara nas duas. Se um dia houver um `packages/ui` com React lá
 * dentro, é este o par que se junta primeiro.
 *
  ...
  return (
    <>
      <div
        ...
        className={cxBusy(
          "w-full px-7 py-6 transition-[filter,opacity] duration-200 motion-reduce:transition-none 2xl:px-10",
