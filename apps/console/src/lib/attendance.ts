 ...
 *
 * Mesmo padrão de `lib/roster.ts` e `lib/calendar.ts`: `data/demo.ts` é estático
...
export function recordAttendance(sessionId: string, absences: { athleteId: string; kind: AbsenceKind }[]) {
  recorded = {
    ...recorded,
